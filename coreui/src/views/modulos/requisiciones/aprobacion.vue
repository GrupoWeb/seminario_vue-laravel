    ...
    export default {
                ...
                table: {
                    ...
                    response: {
                        ...
                        fields: [
                            ...
                            { key: 'fecha' , label: "Fecha Solicitado" },
                            'aprobar',
                            'rechazar'
                            ]
                    }
        ...
        methods: {
            ...
            getInfo(){
                ...
                const requestRequisiciones = axios.get(router[1].get.cargarrequisicionesAprobar + this.token)
            ...
            handleSubmit(){
                axios.post(router[1].post.aprobarRequisicion + this.token,{
                    id: this.form.id
                })
                .then(response => {
                    if(response.status == 200){
