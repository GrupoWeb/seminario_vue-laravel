...
import { router } from '../../../utils/router'
    ...
    export default {
        ...
        methods: {
            ...
            getTipos(){
                axios.get(router[1].get.getTipoGasto + this.token)
                .then(response => {
            ...
            handleSubmit(){
                ...
                axios.post(router[1].post.setTipoGasto + this.token,{
                    name: this.form.name,
                })
                .then(response => {
            ...
            edit(id){
                ...
                axios.post(router[1].post.getTipoGastoById + this.token, {
                    tipo_id: id
                })
                .then(response => {
                    this.form.id = id 
            ...
            deleted(id){
                axios.put(router[1].put.deleteTipoGastoById + this.token,{
                    tipo_id: id
                })
                .then(response => {
                    if(response.status == 200){
            ...
            update(){
                axios.put(router[1].put.updateTipoGastoById + this.token,{
