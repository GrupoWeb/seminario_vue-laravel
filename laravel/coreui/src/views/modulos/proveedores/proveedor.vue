                ...
                >
                    <b-form ref="form" @submit.stop.prevent="handleSubmit">
                        <b-form-group
                                ...
                                >
                                <b-form-input @blur="consultaSat()" v-model="form.nit" placeholder="Ingrese NIT" required></b-form-input>
                        </b-form-group>
                        ...
                        <div v-else>
                            <b-form-group
                                    ...
                                    >
                                    <b-form-input v-model="form.name" placeholder="Ingrese Nombre" required></b-form-input>
                            </b-form-group>
                            <b-form-group
                                    id="direccion"
                                    label="Dirección:"
                                    ...
                                    >
                                    <b-form-input v-model="form.address" placeholder="Ingrese Direccion" required></b-form-input>
                            </b-form-group>
                            <b-form-group
                                    id="telefono"
                                    label="teléfono:"
